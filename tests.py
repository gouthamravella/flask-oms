...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI = 'mysql://root:test1234@localhost/oms_flask_db_test'
        )
    ...
    def setUp(self):
        ...
        admin = Employee(username='admin',password='test1234',is_admin=True)

        #create test non-admin user
        employee = Employee(username='goutham',password='goutham1234')
...
class TestModels(TestBase):
    ...
    def test_department_model(self):
        """
        Test number of records in department model
        """

        #create a department
        department = Department(name='TestDepartment',description = 'TestDescription')
    ...
    def test_role_model(self):
        """
        Tests number of records in Roles model
        """

        #create a role
        role = Role(name='TestRole',description='TestDescription')
...
class TestViews(TestBase):
    ...
    def test_homepage_view(self):
        """
        Test that homepage is accessible without the login
        """
